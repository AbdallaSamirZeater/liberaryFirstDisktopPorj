 ...
 * @author ab o da
 */
public class MultiManTable extends javax.swing.JFrame {
    ...
    public MultiManTable(int id) {
        CRI = id;
        initComponents();
        Home.styleTable(new JTable[]{multiSalesTable});
        multi = createTableCols(multiSalesTable, new String[]{"الاسم", "كود"});
        shows();
    }

    private MultiManTable() {
...
//        }
        ...
        DBcon d = new DBcon();
        String sql2 = "SELECT * FROM `multiman`,mandob WHERE multiman.mandob_id = mandob.id AND CRI = '" + CRI + "';";
        try {
            String name = null;
            d.rs = d.st.executeQuery(sql2);
            int temp;
            while (d.rs.next()) {
                id = String.valueOf(d.rs.getInt("mandob.id"));
                name = d.rs.getString("mandob.name");
                String[] rowData = {id, name};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultiManTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultiManTable().setVisible(true);
            }
        });
    }
