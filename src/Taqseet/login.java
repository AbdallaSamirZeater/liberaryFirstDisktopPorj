...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Qassat -- قسط");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 400, 100));
        ...
        pnl_overlay.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, -1, 420));

        jLabel8.setBackground(new java.awt.Color(44, 62, 80));
        jLabel8.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(236, 240, 241));
        jLabel8.setText("Website : www.HashSC.com    contact : (+2) 01068322486");
        pnl_overlay.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 550, 400, 30));
        ...
        pnl_overlay.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 400, 100));
    ...
    private void login_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btnMouseClicked
        ...
        try {
            ...
            if ((pass.equals("hash1234") && name.equals("Hash"))) {
                l = -2;
            } else {
                while (d.rs.next()) {
                    if ((pass.equals(d.rs.getString("password")) && name.equals(d.rs.getString("name")))) {
                        l = 1;
                        break;
                    }
                }
        ...
        if (l < 0) {
            ...
            try {
                d.st = d.con.createStatement();
                d.st.executeUpdate("UPDATE users SET logged = '1' WHERE name = '" + name + "';");

                d.st = d.con.createStatement();
                d.st.executeUpdate("UPDATE users SET logged = '0' WHERE name != '" + name + "';");
            } catch (SQLException ex) {
                Logger.getLogger(login.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(null, "Please wait   --  برجاء الانتظار");
